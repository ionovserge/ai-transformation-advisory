...
const solutions = [
  // Strategy
  {
    ...
    content: "Переход от Human-Centric к AI-Native: ИИ-агенты — основные исполнители бизнес-процессов.",
    icon: BrainCircuit,
    color: "bg-slate-900",
  ...
  },
  {
    ...
    content: "Сеть специализированных агентов (Аналитик, Контролер, Юрист) под управлением Оркестратора.",
    icon: Zap,
    category_label: 'MAS',
    color: "bg-blue-600",
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl md:text-2xl text-slate-500 mb-16 leading-relaxed max-w-xl font-medium tracking-tight text-left">
              Трансформируем бизнес-процессы в системы автономных AI-агентов. Быстрый запуск, прозрачный ROI, интеграция с тем, что уже работает.
            </p>
            <div className="flex flex-wrap gap-8 items-center">
              <a href="#contact" className="bg-slate-900 text-white px-10 py-5 rounded-[18px] font-bold text-lg hover:bg-blue-600 transition-all shadow-sm active:scale-95 text-center min-w-[240px]">Записаться на аудит</a>
              <a href="#cases" className="text-slate-900 font-bold text-lg flex items-center gap-2 group underline underline-offset-8 decoration-slate-200 hover:decoration-blue-600 transition-all text-left">Смотреть кейсы</a>
            </div>
          </motion.div>
      ...
      <section className="py-32 bg-white border-y border-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-slate-900 mb-6 tracking-tight">Где находится ваш бизнес?</h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">Большинство компаний застревают на первой стадии, инвестируя в AI, но не получая отдачи из-за старой архитектуры.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <MaturityStep level="Stage 01" title="Digital Aware" status="Текущая" desc="ИИ воспринимается как игрушка или угроза. Данные разрознены в Excel, pdf, docx и др. Люди — основные операторы в процессах. ROI < 0.5x." />
            <MaturityStep level="Stage 02" title="AI Ready" status="Переходная" desc="ИИ используется как инструмент (Co-pilot). Есть централизованные данные, но их недостаточно для полной автономности. Люди — операторы ИИ, которые помогают майнить данные для обучения. ROI 1.5–2.5x." />
            <MaturityStep level="Stage 03" title="AI Native" status="Целевая" current={true} desc="Процессы построены вокруг ИИ с нуля. Автономные агенты делают 90% работы и принимают решения. Люди — стратеги, дирижеры и дорогой ресурс для обучения. ROI 3.0–5.0x+." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="bg-white p-14 rounded-[48px] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] border border-slate-100">
                <div className="text-center mb-14">
                  <div className="text-xs font-black text-slate-400 uppercase tracking-[0.3em] mb-8">Три стадии эволюции</div>
                  <div className="flex items-center justify-between relative px-4">
                    <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-slate-100 -translate-y-1/2 z-0" />
                    <div className="relative z-10 w-4 h-4 bg-slate-200 rounded-full" />
                    <div className="relative z-10 w-4 h-4 bg-slate-200 rounded-full" />
                    <div className="relative z-10 w-7 h-7 bg-slate-900 rounded-full ring-[6px] ring-slate-50 shadow-lg" />
                  </div>
                </div>
                <div className="space-y-7">
                  <div className="p-7 rounded-3xl opacity-40 grayscale transition-all">
                    <div className="flex items-center gap-4 mb-3">
                      <span className="text-xl font-bold text-slate-900">1. Digital Aware</span>
                      <span className="text-xs bg-slate-100 px-3 py-1 rounded-full text-slate-500 uppercase font-black tracking-widest">Текущая</span>
                    </div>
                    <p className="text-base text-slate-500 font-medium leading-relaxed">ИИ = игрушка. Данные разрознены. Человек делает всё руками.</p>
                  </div>
                  <div className="p-7 rounded-3xl opacity-60 grayscale transition-all">
                    <div className="flex items-center gap-4 mb-3">
                      <span className="text-xl font-bold text-slate-900">2. AI Ready</span>
                      <span className="text-xs bg-slate-100 px-3 py-1 rounded-full text-slate-500 uppercase font-black tracking-widest">Переходная</span>
                    </div>
                    <p className="text-base text-slate-500 font-medium leading-relaxed">ИИ = инструмент (Co-pilot). Человек — оператор, утверждающий решения.</p>
                  </div>
                  <div className="p-10 bg-slate-900 rounded-[32px] text-white shadow-2xl scale-[1.02] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 blur-3xl rounded-full" />
                    <div className="relative z-10">
                      <div className="flex items-center gap-4 mb-4">
                        <span className="text-xl font-bold">3. AI Native</span>
                        <span className="text-xs bg-blue-600 px-3 py-1 rounded-full text-white uppercase font-black tracking-widest">Целевая</span>
                      </div>
                      <p className="text-lg text-slate-400 leading-relaxed font-medium">Процессы автономны. Мультиагентные системы делают 90% работы. Человек — стратег и дирижер.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-400 mb-12 leading-relaxed font-medium">
                AI без понимания бизнеса — дорогая игрушка. Мы не просто IT-компания, мы бизнес-консультанты, которые сначала исправляют процессы, а потом внедряют искусственный интеллект.
              </p>
              <div className="space-y-10">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm font-medium leading-relaxed">Находим, где реально теряются время и деньги. Структурируем цепочки создания ценности, анализируем зоны ответственности и роли людей в процессе.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm font-medium leading-relaxed">Проводим реинжиниринг структуры процесса, функций и распределения ролей. Подбираем оптимальные инструменты для работы с вашими данными. Определяем фокусные области для AI бустинга вашего бизнеса.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm font-medium leading-relaxed">Проектируем мультиагентные системы в кластерах ваших продуктов и процессах с высокой концентрацией расходов и OPEX. Запускаем автономных агентов и агентов с HITL в ваши процессы с понятным ROI и критериями успеха.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[48px] shadow-2xl">
                <div className="text-center mb-6">
                  <div className="text-5xl font-bold text-blue-400 mb-2 tracking-tighter">ROI 140%</div>
                  <div className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em]">за первый год внедрения</div>
                </div>
                {/* SVG Chart */}
                <svg viewBox="0 0 400 220" className="w-full" style={{ overflow: 'visible' }}>
                  <defs>
                  ...
                  {/* Grid lines */}
                  {[0, 50, 100, 140].map(v => {
                    const y = 170 - (v / 170) * 150;
                    return <line key={v} x1="45" y1={y} x2="385" y2={y} stroke="rgba(148,163,184,0.15)" strokeWidth="0.5" />;
                  })}
                  {/* Zero line (break-even) */}
                  <line x1="45" y1="170" x2="385" y2="170" stroke="rgba(148,163,184,0.4)" strokeWidth="1" strokeDasharray="6 4" />
                  <text x="388" y="174" fill="rgba(148,163,184,0.6)" fontSize="7" fontWeight="700" textAnchor="start">0%</text>
                  {/* Y-axis labels */}
                  <text x="40" y="174" fill="rgba(148,163,184,0.5)" fontSize="8" fontWeight="700" textAnchor="end">0%</text>
                  <text x="40" y={170 - (50/170)*150 + 3} fill="rgba(148,163,184,0.5)" fontSize="8" fontWeight="700" textAnchor="end">50%</text>
                  <text x="40" y={170 - (100/170)*150 + 3} fill="rgba(148,163,184,0.5)" fontSize="8" fontWeight="700" textAnchor="end">100%</text>
                  <text x="40" y={170 - (140/170)*150 + 3} fill="#60a5fa" fontSize="8" fontWeight="800" textAnchor="end">140%</text>
                  <text x="40" y="196" fill="rgba(248,113,113,0.7)" fontSize="8" fontWeight="700" textAnchor="end">−30%</text>
                  {/* Negative ROI area (months 1-4) */}
                  <path d={`M${45 + 0*(340/11)} 170 L${45 + 0*(340/11)} ${170 + 20} L${45 + 1*(340/11)} ${170 + 25} L${45 + 2*(340/11)} ${170 + 18} L${45 + 3*(340/11)} ${170 + 5} L${45 + 3*(340/11)} 170 Z`} fill="url(#lossGrad)" />
                  {/* Positive ROI fill area */}
                  <path d={`M${45 + 3*(340/11)} 170 L${45 + 4*(340/11)} ${170 - (15/170)*150} L${45 + 5*(340/11)} ${170 - (30/170)*150} L${45 + 6*(340/11)} ${170 - (50/170)*150} L${45 + 7*(340/11)} ${170 - (70/170)*150} L${45 + 8*(340/11)} ${170 - (90/170)*150} L${45 + 9*(340/11)} ${170 - (110/170)*150} L${45 + 10*(340/11)} ${170 - (125/170)*150} L${45 + 10*(340/11)} 170 Z`} fill="url(#roiFill)" />
                  {/* ROI curve */}
                  <polyline
                    points={`${45},${170 + 20} ${45 + 1*(340/11)},${170 + 25} ${45 + 2*(340/11)},${170 + 18} ${45 + 3*(340/11)},${170 + 5} ${45 + 4*(340/11)},${170 - (15/170)*150} ${45 + 5*(340/11)},${170 - (30/170)*150} ${45 + 6*(340/11)},${170 - (50/170)*150} ${45 + 7*(340/11)},${170 - (70/170)*150} ${45 + 8*(340/11)},${170 - (90/170)*150} ${45 + 9*(340/11)},${170 - (110/170)*150} ${45 + 10*(340/11)},${170 - (125/170)*150}`}
                    fill="none" stroke="#60a5fa" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"
                  />
                  {/* Cumulative investment line (flat after month 3) */}
                  <polyline
                    points={`${45},${170 - (10/170)*150} ${45 + 1*(340/11)},${170 - (25/170)*150} ${45 + 2*(340/11)},${170 - (30/170)*150} ${45 + 3*(340/11)},${170 - (30/170)*150} ${45 + 10*(340/11)},${170 - (30/170)*150}`}
                    fill="none" stroke="rgba(248,113,113,0.5)" strokeWidth="1.5" strokeDasharray="4 3" strokeLinecap="round"
                  />
                  {/* Break-even marker at month ~4 */}
                  <circle cx={45 + 3*(340/11)} cy={170 + 5} r="4" fill="#1e293b" stroke="#60a5fa" strokeWidth="2" />
                  <text x={45 + 3*(340/11)} y={170 + 5 - 8} fill="#60a5fa" fontSize="7" fontWeight="800" textAnchor="middle">BREAK-EVEN</text>
                  {/* End point */}
                  <circle cx={45 + 10*(340/11)} cy={170 - (125/170)*150} r="5" fill="#60a5fa" />
                  <circle cx={45 + 10*(340/11)} cy={170 - (125/170)*150} r="8" fill="none" stroke="#60a5fa" strokeWidth="1" opacity="0.4" />
                  <text x={45 + 10*(340/11)} y={170 - (125/170)*150 - 12} fill="#60a5fa" fontSize="9" fontWeight="800" textAnchor="middle">+140%</text>
                  {/* X-axis month labels */}
                  {Array.from({ length: 11 }, (_, i) => (
                    <text key={i} x={45 + i*(340/10)} y="210" fill="rgba(148,163,184,0.5)" fontSize="8" fontWeight="600" textAnchor="middle">
                      {['М1','М2','М3','М4','М5','М6','М7','М8','М9','М10','М11','М12'][i]}
                    </text>
                  ))}
                </svg>
                {/* Legend */}
                <div className="flex items-center justify-center gap-6 mt-4 pt-4 border-t border-white/5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Кумулятивный ROI</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-0.5 rounded-full" style={{ background: 'rgba(248,113,113,0.5)', borderTop: '1px dashed' }} />
                    <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Инвестиции</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-40 bg-white border-y border-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-5xl font-bold text-slate-900 mb-6 tracking-tight">Экономика AI-Native систем</h2>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">Реальные показатели из нашего каталога внедрений. ROI достигает 5.0x на горизонте 24 месяцев.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <StatCard icon={Zap} trend="up" label="Ускорение процессов" value="в 4-5 раз" sub="Сокращение циклов согласования документов с дней до минут. Скрининг многостраничных документов за минуты вместо часов и дней." />
          </div>
        </div>
      </section>
      ...
      <section id="solutions-hub" className="py-40 bg-[#FBFBFD]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center mb-24 gap-8">
            <div className="text-center text-slate-900 group">
              <h2 className="text-6xl font-bold mb-6 tracking-tighter whitespace-nowrap">Интерактивный хаб <span className="text-blue-600/80 group-hover:text-blue-700 transition-colors duration-500">AI-решений</span></h2>
              ...
              {filteredSolutions.map(sol => (
                <motion.div key={sol.id} layout initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} onClick={() => setSelectedSolution(sol)}
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <p className="text-sm text-slate-500 font-medium mb-10 flex-grow text-left leading-relaxed">{sol.content}</p>
      ...
      <section id="roadmap" className="py-40 bg-white border-y border-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-32">
            <h2 className="text-5xl font-bold text-slate-900 mb-6 tracking-tight">Дорожная карта трансформации</h2>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">Невидимый экзоскелет, а не пересадка сердца. Мы не ломаем текущую IT-инфраструктуру.</p>
          </div>
          <div className="relative">
            ...
            {cases.map(c => (
              <motion.div key={c.id} onClick={() => setSelectedCase(c)} whileHover={{ y: -6 }}
                ...
                <div className="p-7 flex flex-col flex-grow">
                  ...
                  {/* Problem excerpt */}
                  <p className="text-sm text-slate-500 leading-relaxed mb-6 flex-grow">{c.shortProblem || c.problem}</p>
                  {/* Results */}
      ...
      <section id="contact" className="py-40 bg-[#FBFBFD] border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          <div className="text-left">
            ...
            <p className="text-xl text-slate-500 mb-20 leading-relaxed font-medium">Перестаньте быть главным исполнителем рутины и тушителем пожаров. Отдайте хаос алгоритмам и сосредоточьтесь на стратегии. Ваш бизнес готов к запуску на новой скорости..</p>
